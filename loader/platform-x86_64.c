...
#if 0
	4005 c3:49 b9 66 66 66 66 66 movabs $0x6666666666666666, %r9
		4005 ca:66 66 66
		4005 cd:49 b8 55 55 55 55 55 movabs $0x5555555555555555, %r8
		4005 d4:55 55 55
		4005 d7:48 b9 44 44 44 44 44 movabs $0x4444444444444444, %rcx
		4005 de:44 44 44
		4005e1:48 ba 33 33 33 33 33 movabs $0x3333333333333333, %rdx
		4005e8:33 33 33
		4005eb:48 be 22 22 22 22 22 movabs $0x2222222222222222, %rsi
		4005f 2:22 22 22
		4005f 5:48 bf 11 11 11 11 11 movabs $0x1111111111111111, %rdi 4005f c:11 11 11 rest in stack
#endif
		switch (param) {
	case 0:
		return (void *)(mctx->gregs[REG_RDI]);
		break;
	case 1:
		return (void *)(mctx->gregs[REG_RSI]);
		break;
	case 2:
		return (void *)(mctx->gregs[REG_RDX]);
		break;
	case 3:
		return (void *)(mctx->gregs[REG_RCX]);
		break;
	case 4:
		return (void *)(mctx->gregs[REG_R8]);
		break;
	case 5:
		return (void *)(mctx->gregs[REG_R9]);
		break;
	default:
