...
#if 0
	0002969 c < open >:2969 c:94 21 ff 80 stwu r1, -128(r1)
	-- 000610 a0 < __mmap >:610 a0:94 21 ff c0 stwu r1, -64(r1)
	-- 0008287 c < fstat >:8287 c:94 21 ff c0 stwu r1, -64(r1)
	-- 000 ad680 < close >:ad680:94 21 ff d0 stwu r1, -48(r1)
	-- 000 af880 < pread >:af880:94 21 ff c0 stwu r1, -64(r1)
	-- 000 afac0 < read >:afac0:94 21 ff e0 stwu r1, -32(r1)
#endif
	 offset = 256 - bottom;
