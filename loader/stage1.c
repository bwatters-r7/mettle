...
int main(int argc, char **argv)
{
	...
	fflush(stdout);
	load_blob((unsigned char *)&libcrypto_start, (int)&libcrypto_size, libcrypto_raw,
		&libcrypto_blob);
	...
	fflush(stdout);
	load_blob((unsigned char *)&libsupport_start, (int)&libsupport_size, libsupport_raw,
		&libsupport_blob);
	...
	fflush(stdout);
	load_blob((unsigned char *)&libmetsrv_main_start, (int)&libmetsrv_main_size, libmetsrv_main_raw,
		&libmetsrv_main_blob);
