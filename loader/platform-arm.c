...
void *platform_arg(mcontext_t * mctx, int param)
{
	...
	switch (param) {
	case 0:
		return (void *)(mctx->arm_r0);
	case 1:
		return (void *)(mctx->arm_r1);
	case 2:
		return (void *)(mctx->arm_r2);
	case 3:
		return (void *)(mctx->arm_r3);
	default:
...
#if 0
	0002453 c < open >:2453 c:e92d000e push {
	r1, r2, r3} 0006444 c < __mmap >:6444 c:e92d4830 push {
	r4, r5, fp, lr} 000827 b8 < fstat >:827 b8:e92d4800 push {
	fp, lr} 000 a7d34 < close >:a7d34:e92d4800 push {
	fp, lr} 000 a95f0 < pread >:a95f0:e92d4810 push {
	r4, fp, lr} 000 a97d8 < read >:a97d8:e92d4800 push {
	fp, lr}
#endif
	if (top != 0xe92d) {
